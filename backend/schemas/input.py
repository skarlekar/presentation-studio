...
class DeckRequest(BaseModel):
    ...
    run_id: str | None = Field(
        default=None,
        description=(
            "Short human-readable run identifier generated by the client at intake time "
            "(e.g. 'DS-2603-8F4A'). Included in the export filename and all response "
            "envelopes for traceability across the full pipeline lifecycle."
        ),
        examples=["DS-2603-8F4A"],
    )
